...
const ICONS = {
  ...
  steam: '<svg viewBox="0 0 24 24" fill="currentColor"><circle cx="12" cy="12" r="9.5" fill="none" stroke="currentColor" stroke-width="1.4"/><circle cx="8.6" cy="14.8" r="1.7"/><circle cx="15.2" cy="9.6" r="2.4" fill="none" stroke="currentColor" stroke-width="1.4"/><path d="M8.6 14.8 12.2 12" stroke="currentColor" stroke-width="1.4" fill="none"/></svg>',
